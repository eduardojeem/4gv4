  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md items-center px-4 py-10">
      <Card className="w-full">
        <CardHeader>
          <Link href={redirectTo} className="mb-4 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
          ...
          <CardDescription>
            Una sola cuenta para comprar en el marketplace y en todas las tiendas.
          </CardDescription>
        </CardHeader>
        <CardContent>
...
export default function MarketplaceCustomerRegisterPage() {
  return (
    <Suspense>
      <MarketplaceCustomerRegisterForm />
    </Suspense>
  )
}
