...
export default function SupabaseVerificationPage() {
  ...
  const loadSampleData = async () => {
    ...
    try {
      ...
      await insertIfEmpty('categories', [
        { name: 'Smartphones', description: 'Telefonos inteligentes y dispositivos moviles', is_active: true },
        { name: 'Accesorios', description: 'Accesorios para dispositivos moviles', is_active: true },
      ...
      await insertIfEmpty('brands', [
        { name: 'Apple', description: 'Tecnologia innovadora y diseno premium', website: 'https://www.apple.com', is_active: true },
        { name: 'Samsung', description: 'Lider mundial en tecnologia movil', website: 'https://www.samsung.com', is_active: true },
      ])
      ...
      await insertIfEmpty('products', [
        {
          ...
          category_id: catSmart?.id ?? null,
          brand: 'Apple',
          supplier_id: supApple?.id ?? null,
        ...
        },
        {
          ...
          category_id: catSmart?.id ?? null,
          brand: 'Samsung',
          supplier_id: supSamsung?.id ?? null,
        ...
        },
        {
          ...
          description: 'Cargador rapido USB-C 30W',
          category_id: catAcc?.id ?? null,
          brand: 'TechCorp',
          supplier_id: supSamsung?.id ?? null,
          purchase_price: 9900,
          sale_price: 19900,
      ...
      if (productIphone?.id) {
        ...
        await insertIfEmpty('product_price_history', [
          {
            product_id: productIphone.id,
            old_purchase_price: 999000,
            new_purchase_price: 949000,
            old_sale_price: 1299000,
            new_sale_price: 1249000,
            reason: 'Ajuste de precios por campana',
          },
        ])
      }
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Verificacion de Tablas de Supabase</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-center gap-2 text-red-800">
                ...
                <span className="font-semibold">Error de conexion</span>
              </div>
          ...
          <div className="space-y-3">
            {results.map((check) => (
              <div
                key={check.name}
                className={`border rounded-lg p-4 ${check.exists ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}
              >
          ...
          {results.some((result) => !result.exists) && (
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <h3 className="font-semibold text-yellow-900 mb-2">Instrucciones de Configuracion</h3>
