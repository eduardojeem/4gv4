...
const WEBSITE_GUIDES: WebsiteSectionGuide[] = [
  ...
  },
  {
    ...
    locationTag: 'Carrito, Checkout y Opciones de Entrega',
    steps: [
      {
        number: '1',
        title: 'Elegir la Modalidad Comercial de la Tienda',
        description: 'Define cómo interactúan tus clientes: Carrito Completo (pago y envío en línea), Pedidos por WhatsApp (abre chat con producto y precio) o Modo Catálogo (vitrina de exhibición sin carrito).',
        highlight: 'Adapta el flujo de compra a la dinámica de atención de tu negocio.',
        actionLabel: 'Seleccionar modalidad de tienda',
      },
      {
        number: '2',
        title: 'Habilitar Métodos de Pago y Datos Bancarios',
        description: 'Activa Efectivo (contra entrega/retiro), Tarjeta (Posnet), Transferencias Bancarias múltiples (con Alias, CBU, Banco y Titular) y Billeteras Digitales / QR con instrucciones de pago.',
        highlight: 'El cliente ve los datos bancarios exactos y el QR en pantalla al confirmar su pedido.',
        actionLabel: 'Configurar métodos de pago',
      },
      {
        number: '3',
        title: 'Definir Zonas de Delivery y Tarifas de Envío',
        description: 'Configura las zonas de reparto de tu ciudad con sus tarifas (ej. Centro, Gran Asunción, Envíos al Interior) y tiempos estimados de entrega. Puedes configurar zonas con envío gratuito.',
        highlight: 'El costo del delivery se suma automáticamente al total del pedido en el carrito.',
        actionLabel: 'Configurar zonas de delivery',
      },
      {
        number: '4',
        title: 'Habilitar Retiro en Local / Mostrador (Pick-up)',
        description: 'Permite que los clientes retiren sus pedidos en tu tienda física sin costo de envío. Puedes especificar la dirección de retiro, horarios habilitados e indicaciones especiales.',
        highlight: 'Ideal para atraer clientes a tu mostrador y ofrecer retiro rápido en el día.',
        actionLabel: 'Activar retiro en tienda',
      },
    ],
    proTips: [
      'Si tienes local a la calle, mantén siempre activo "Retiro en local" gratis para captar clientes cercanos y vender accesorios en el mostrador.',
      'Carga al menos 2 opciones de transferencia (banco tradicional y billetera/QR) para que el cliente elija la que no le cobre comisión interbancaria.',
      'Configura instrucciones claras en cada método de pago (ej. "Enviar comprobante al WhatsApp con el número de pedido").',
    ],
    publicImpact: 'Afecta: Carrito de compras, cálculo de envíos, pasarela de confirmación de pedido y modalidades de cobro.',
  },
]
...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    relatedTab: 'checkout',
    question: '¿Cómo configuro varias cuentas bancarias para transferencias?',
    answer: 'En la pestaña "Pagos y entregas", activa "Transferencia" y en el editor de cuentas bancarias haz clic en "Agregar cuenta". Puedes añadir Banco, Alias, CBU/Número de cuenta y Titular para que el cliente elija su banco de preferencia.',
  },
  {
    id: 'faq-4',
    category: 'Envíos & Delivery',
    relatedTab: 'checkout',
    question: '¿Cómo funcionan las zonas de delivery y tarifas de envío?',
    answer: 'En "Envío a domicilio", puedes crear zonas personalizadas (ej. Centro: 10.000 Gs., Gran Asunción: 25.000 Gs., Interior: A coordinar). Cuando el cliente compra en el carrito, selecciona su zona y el costo se calcula y suma automáticamente al total.',
  },
  {
    id: 'faq-5',
    ...
    answer: 'Sí. En "Pagos y entregas", cambia la Modalidad Comercial a "Consultas por WhatsApp". El carrito se ocultará y cada producto mostrará un botón que abre WhatsApp con el nombre y precio del producto listo para enviar.',
  },
  {
    id: 'faq-6',
