...
/** Planes oficiales sincronizados con el sistema */
export const defaultSyncPlans: SaaSPlan[] = [
  {
    ...
    yearlyPrice: 120000,
    trial_days: 20,
    description: 'Para negocios y talleres que necesitan control de stock, turnos de caja y módulo de reparaciones.',
    badge: '20 Días Gratis',
    cta: 'Probar Plan Lite',
    featured: false,
    is_popular: false,
    limits: {
      users: '5 usuarios',
  ...
  },
  {
    ...
    yearlyPrice: 280000,
    trial_days: 7,
    description: 'Para empresas en crecimiento con múltiples sucursales, tienda ecommerce y análisis de rentabilidad.',
    badge: 'Más Elegido',
    cta: 'Probar Plan Pro',
    featured: true,
    is_popular: true,
    ...
    highlights: [
      ...
      'Ecommerce propio & Catálogo sincronizado',
  ...
  },
  {
    ...
    name: 'PRO+',
    price: 550000,
    priceFormatted: 'Gs. 550.000',
    yearlyPrice: 440000,
    trial_days: 7,
    description: 'Para empresas con alta demanda, delivery, despacho y sucursales ilimitadas.',
    badge: '7 Días Gratis',
    cta: 'Probar Plan Pro+',
    featured: false,
    is_popular: false,
    limits: {
      users: '50 usuarios',
      products: '50.000 ítems',
      branches: 'Ilimitadas',
      repairs: 'Ilimitadas',
    },
    highlights: [
      'Hasta 50 usuarios concurrentes',
      'Hasta 50.000 productos y servicios',
      'Sucursales y cajas ilimitadas',
      'Módulo de Delivery & Despacho logístico',
      'Ecommerce avanzado con multi-depósito',
