...
export const saasHighlights = [
  ...
  {
    title: 'Stock Físico & Servicios',
    description: 'Control estricto de existencias físicas y catálogo de servicios profesionales (sin límite de stock) en múltiples sucursales.',
    icon: Boxes,
    color: 'emerald',
  ...
  {
    title: 'Publica tu catálogo online',
    description: 'Tu propio ecommerce y marketplace sincronizado en tiempo real con el inventario físico del POS sin desfases de stock.',
    icon: Store,
    color: 'violet',
    className: 'lg:col-span-7',
