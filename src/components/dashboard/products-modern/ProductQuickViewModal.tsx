...
export function ProductQuickViewModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose() }}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl p-5 sm:p-6 border border-slate-200/80 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md shadow-2xl">
        <DialogHeader>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 rounded-2xl bg-blue-50/70 dark:bg-blue-950/30 border border-blue-200/60 dark:border-blue-800/60 text-center">
              <p className="text-[11px] font-bold text-blue-700 dark:text-blue-400 mb-0.5">Stock actual</p>
              <p className={cn('text-lg font-black tabular-nums', statusConfig.text)}>
                {product.stock_quantity} <span className="text-xs font-normal text-muted-foreground">u</span>
              </p>
            </div>
