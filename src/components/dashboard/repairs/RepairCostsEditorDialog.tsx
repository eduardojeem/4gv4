...
function RepairCostsEditorForm({ open, repair, maxDiscountPercent, laborTaxRate, onOpenChange, onSaved }: {
  ...
  return <Dialog open={open} onOpenChange={(next) => !saving && onOpenChange(next)}>
    <DialogContent className="flex h-[96dvh] max-h-[900px] w-[calc(100%-1rem)] max-w-6xl flex-col gap-0 overflow-hidden p-0 sm:h-auto sm:max-h-[94dvh]">
      ...
      <div className="flex-1 overflow-y-auto bg-muted/20 p-3 sm:p-5">
        {step === 'edit' ? <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_320px]"><div className="space-y-4">
