-- ============================================================================
-- Branch inventory transfer RPC
-- Fecha: 2026-06-22
-- Objetivo:
--   - trasladar stock entre dos sucursales en una sola transaccion
--   - validar stock disponible y acceso a ambas sucursales
--   - registrar las dos patas del traslado en product_movements
-- ============================================================================
